...
# np.save('data/location7x7.npy', locations)
# np.save('data/adjacency_mat7x7.npy', adjacency_mat)

np.save('data/location10x10_maze.npy', locations)
np.save('data/adjacency_mat10x10_maze.npy', adjacency_mat)
